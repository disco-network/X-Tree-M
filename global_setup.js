 ...
 * V0.0.0.4	2013/09/05	Men� klappt (verdr�ngend), Resize ohne Scrolling wegen
 * 				prozentualen Gr��en; Datenbank-Anbindung klappt zusammen
 * 				mit Darstellung (Aktualisierung : DB-Anbindung mittler-
 * 				weile veraltet)
 * V0.0.0.5	2013/09/30 	Mouseover, Men� und y-Scrolling klappt; blauer Hintergrund;
 * 				Navigationsleiste
 * V0.0.0.6	2013/10/01	Men� jetzt �berlappend statt verdr�ngend
 ...
 * 				eleganter Code)
 * V0.0.0.15    2013/11/11      Version wird unter Hilfe-Men� angezeigt
